 ...
 *
 * Plugin Name:  A Vertical Timeline Responsive
 * Plugin URI:   
 * Description:  A simple plugin to add clean and nice time line in pages, posts.
 * Author:       Jahur Ahmed
 ...
 *
 */
define( 'VTIMERES_PLUGIN_URL', plugin_dir_url( __FILE__ ) );
...
//require_once dirname( __FILE__ ) . '/frontend/functions/functions.php';
require_once dirname( __FILE__ ) . '/frontend/functions/shortcodes.php';
//require_once dirname( __FILE__ ) . '/frontend/assets/js/slider-init-js.php';

$VTLR_POST_TYPE = new VTLR_POST_TYPE();
$VTLR_POST_TYPE -> init();

//require_once 'plugin-option.php';

// text meta box

add_action( 'add_meta_boxes', 'cd_meta_box_add_vtlr' );
function cd_meta_box_add_vtlr()
{
    add_meta_box( 'my-meta-box-id', 'Vertical timeline shortcode', 'cd_meta_box_vtlr', 'vtlr', 'side', 'high' );
}
...
{ 
    ...
    ?>
    <input type="text" name="my_meta_box_text" id="my_meta_box_text" value="&#91;vtimeline id&#61;&quot;<?php the_ID(); ?>&quot;&#93;" readonly/>
    <?php 
}