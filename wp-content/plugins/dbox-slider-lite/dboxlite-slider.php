...
define("DBOXLITE_SLIDER_VER","1.2.2",false);//Current Version of DboxLite Slider
...
global $dboxlite_slider;
 if(isset($_POST['dboxlite-sldr-verify']) and current_user_can( $dboxlite_slider['user_level'] ) ) {
	...
	$post_dbox_sslider_nolink = $_POST['dboxlite_sslider_nolink'];
	if($dbox_sslider_nolink != $post_dbox_sslider_nolink) {
	  update_post_meta($post_id, 'dbox_sslider_nolink', $_POST['dboxlite_sslider_nolink']);	
	}
